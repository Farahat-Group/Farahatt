...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{url('boards/' . $board['id'] ) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <input type="hidden" name="userid" value="{{$board['id']}}">
            <div class="row mx-5 mb-4">
                <div class="col-2">
                    <label for="username" class="col-form-label">Title</label>
                </div>
                <div class="col-10">
                    <input type="text" name="title" id="username" required="required" class="form-control" autocomplete="off" value="{{$board['title']}}">
                </div>
            </div>
            ...
            <div class="row mx-5 mb-4">
                ...
                <div class="col-10">
                    <input type="text" name="description" id="username" required="required" class="form-control" autocomplete="off" value="{{$board['description']}}">
                </div>
            </div>
