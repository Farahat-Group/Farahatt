    ...
    <div class="container">
        ...
        <form action="{{url('contact/' . $contact['id'] ) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mx-5 mb-4">
                <div class="col-2">
                    <label for="username" class="col-form-label">link</label>
                </div>
                <div class="col-10">
                    <input type="text" name="link" id="username" required="required" class="form-control" autocomplete="off" value="{{$contact['link']}}">
                </div>
            </div>
            ...
            <div class="row mx-5 mb-4">
                ...
                <div class="col-10">
                    <input type="file" name="icon" id="username"  class="form-control" autocomplete="off">
                </div>
            </div>
